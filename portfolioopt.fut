...
module mk_portfolioopt (T: real): portfolioopt with t = T.t = {
    ...
    def efficient_return [n] (target_return: t) (mus: [n]t) (covs: [n][n]t) =
        ...
        -- Objective function
        let f0 (x: [n]t) = 
            expected_risk x covs

        -- Solve the problem
        in mod.solve_qp h f0 A b
    ...
    def max_sharpe_ratio [n] (risk_free_rate: t) (mus: [n]t) (covs: [n][n]t) =
        ...
        -- Objective function
        let f0 (x: [n]t) = 
            T.neg ((expected_return x mus) T.- risk_free_rate) T./ (expected_risk x covs)
